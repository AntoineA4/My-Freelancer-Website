        ...
        <section className="WhyMe-section">
            ...
            <div className="whyMe-flex">
                ...
                <div className="whyMe-card">
                    ...
                    <div className="whyMe-desc">Tu parles avec le dev, pas un commercial ou un chef de projet</div>
                </div>
                <div className="whyMe-card">
                    <div className="whyMe-icon">
                    ...
                    <div className="whyMe-title">Tu restes propriétaire</div>
                    <div className="whyMe-desc">Tous les accès, fichiers sources et le domaine te sont remis</div>
                </div>
            </div>
        </section>
