    ...
    return (
        <section>
            <div className="container">
                ...
                <div className="pq-card">
                    <div className="pq-icon">
                        <svg viewBox="0 0 24 24" stroke-width="1.5"><path d="M3 11l19-9-9 19-2-8-8-2z"/></svg>
                    </div>
                    <div>
                ...
                <div className="pq-card">
                    <div className="pq-icon">
                        <svg viewBox="0 0 24 24" stroke-width="1.5"><path d="M20 7H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>
                    </div>
                    <div>
                ...
                <div className="pq-card">
                    <div className="pq-icon">
                        <svg viewBox="0 0 24 24" stroke-width="1.5"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>
                    </div>
                    <div>
